# Install golaunch into %LOCALAPPDATA%\bin.
#
...
function Write-PostInstallNote {
    Write-Host "Run '$Binary' in a directory to launch scripts against a file selection:"
    Write-Host "  $Binary ~/projects"
}
# ---- end config ----
